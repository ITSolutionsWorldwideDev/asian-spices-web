        ...
        <div className="max-w-xl text-center">
          ...
          <div className="flex justify-center mt-8">
            <Link href={`/kitchen-appliances`}>
              <button className="px-8 py-3 bg-white cursor-pointer text-gray-900 font-semibold rounded-lg shadow-lg hover:bg-black hover:text-white transition duration-300">
                Shop Appliances
              </button>
            </Link>
          </div>
